export default async function Page() {
	return (
		<div className="m-auto mt-24 flex flex-col items-center gap-10">
			<span className="text-4xl text-center">Login to <span className="font-bold text-[rgb(100,108,255)]">What Notepad</span></span>
			<a href="/login/github">
